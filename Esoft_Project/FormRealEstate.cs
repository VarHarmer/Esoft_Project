...
namespace Esoft_Project
{
    public partial class FormRealEstate : Form
    {
        ...
        void ShowClient()
        {
            ...
            foreach (RealEstateSet realEstateSet in Program.bazadb.RealEstateSet)
            {
                ListViewItem item = new ListViewItem(new string[]
                {
                    realEstateSet.Id.ToString(), realEstateSet.Address_City, realEstateSet.Address_Street,
        ...
        private void comboBoxType_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                listViewRealEstateSet_House.Visible = true; labelTotalFloors.Visible = true; textBoxTotalFloors.Visible = true;
        ...
        void ShowRealEstateSet()
        {
            ...
            foreach (RealEstateSet realEstate in Program.bazadb.RealEstateSet)
            {
        ...
        private void buttonDel_Click_1(object sender, EventArgs e)
        {
            try
            {
                if (comboBoxType.SelectedIndex == 0)
                {
                    ...
                    {
                        RealEstateSet realEstate = listViewRealEstateSet_Apartment.SelectedItems[0].Tag as RealEstateSet;
                        Program.bazadb.RealEstateSet.Remove(realEstate);
                        Program.bazadb.SaveChanges();
                        ShowRealEstateSet();
                    }
                    textBoxAddress_City.Text = "";
            ...
            {
                MessageBox.Show("Heвoзмoжнo удалить, эта запись используется", "Ошибка", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
