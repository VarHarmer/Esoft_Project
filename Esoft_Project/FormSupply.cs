...
namespace Esoft_Project
{
    public partial class FormSupply : Form
    {
        ...
        void ShowAgents()
        {
            ...
            foreach (AgentsSet agentsSet in Program.bazadb.AgentsSet)
            {
        ...
        void ShowRealEstate()
        {
            ...
            {
                string[] item = { realEstateSet.Id.ToString() + ".", realEstateSet.Address_City + ",", realEstateSet.Address_Street + ",", "д. "+ realEstateSet.Address_House + ",",
        ...
        private void buttonAdd_Click(object sender, EventArgs e)
        {
            if (comboBoxAgents.SelectedItem != null && comboBoxClients.SelectedItem != null && comboBoxRealEstate != null && textBoxPrice.Text != "")
            {
                ...
                Program.bazadb.SupplySet.Add(supply);
        ...
        void ShowSupplySet()
        {
            ...
            foreach (SupplySet supply in Program.bazadb.SupplySet)
            {
        ...
        private void buttonDel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    SupplySet supply = listViewSupplySet.SelectedItems[0].Tag as SupplySet;
                    Program.bazadb.SupplySet.Remove(supply);
                    Program.bazadb.SaveChanges();
                    ShowSupplySet();
                }
                comboBoxAgents.SelectedItem = null;
